...
export default function MetricGroup01() {
    return (
        <Container className="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6">
            <Container className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                <Container className="flex h-12 w-12 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800">
                    <svg
                ...
                <Container className="mt-5 flex items-end justify-between">
                    <Container>
                        <Span className="text-sm text-gray-500 dark:text-gray-400">All Orders</Span>
                        <Heading level={4}
                                 className="mt-2 text-title-sm font-bold text-gray-800 dark:text-white/90"
                        >
                            5,359
                        </Heading>
                    </Container>
            ...
            <Container className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                ...
                <Container className="mt-5 flex items-end justify-between">
                    ...
                    <Span
                        className="flex items-center gap-1 rounded-full bg-success-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-success-600 dark:bg-success-500/15 dark:text-success-500"
                    >
                        <svg
                            className="fill-current"
                            width="12"

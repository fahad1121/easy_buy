...
export default function Chart01() {
    ...
    return (
        <Container className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
            <Container className="flex items-center justify-between">
                <Heading level={3} className="text-lg font-semibold text-gray-800 dark:text-white/90">
                    Monthly Sales
                </Heading>
                <Container ref={dropdownRef} className="relative h-fit">
                    <Button
            ...
            <Container className="custom-scrollbar max-w-full overflow-x-auto">
                <Container className="-ml-5 min-w-[650px] pl-2 xl:min-w-full">
                    <Container
                        id="chartOne"

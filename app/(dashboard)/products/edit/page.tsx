...
export default function Page() {
    ...
    return (
        <Container className="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
            <Container>
                <BreadCrumb title="Update a product" prefix="products" page="update product"/>
            </Container>
                    ...
                    <Container className="p-5 border-t border-gray-100 dark:border-gray-800 sm:p-6">
                            <Form className="w-full bg-white shadow-md rounded-lg p-8">
                                ...
                                <Container className="mb-6">
                                    ...
                                    <Input type="file" className="w-full bg-gray-200 text-gray-700 border rounded py-3 px-4"
                                    />
                                </Container>
                                ...
                                <Container className="flex justify-end">
                                    <Button type="submit" className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded">
                                        update Product
                                    </Button>
                                </Container>
                            </Form>
